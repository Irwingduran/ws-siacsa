          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://x.com/siaacsa" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#EF7632]">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/#contact" className="text-gray-600 hover:text-[#EF7632]">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/products#expansion-directa" className="text-gray-600 hover:text-[#EF7632]">
                  Expansión Directa
                  </Link>
                </li>
                <li>
                  <Link href="/products#agua-helada" className="text-gray-600 hover:text-[#EF7632]">
                  Agua Helada
                  </Link>
                </li>
                <li>
                  <Link href="/products#vrf" className="text-gray-600 hover:text-[#EF7632]">
                    Sistemas VRF
                  </Link>
                </li>
                <li>
                  <Link href="/products#herramientas-controles" className="text-gray-600 hover:text-[#EF7632]">
